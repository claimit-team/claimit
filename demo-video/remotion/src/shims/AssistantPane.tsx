...
export const AssistantPane: React.FC<{
  messages?: Msg[];
  highlightAction?: string;
  style?: CSSProperties;
}> = ({ messages = [], highlightAction, style }) => (
  <div
    style={{
      display: "flex",
  ...
  >
          ...
          >
            <div
              style={{
                ...
                borderRadius: 12,
                backgroundColor:
                  m.role === "assistant" ? "rgba(15,20,25,0.05)" : colors.brand.primary,
    ...
    {/* input */}
    <div
      style={{ borderTop: "1px solid rgba(15,20,25,0.08)", padding: 14, display: "flex", gap: 8 }}
    >
      <div
        style={{
          flex: 1,
