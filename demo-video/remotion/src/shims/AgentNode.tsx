...
export const AgentNode: React.FC<{
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 10, fontFamily: FONT_STACK_TEXT, ...style }}>
      ...
      >
        <svg width={34} height={34} viewBox="0 0 24 24" fill="none" stroke={colors.brand.primary} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
          <path d="M12 8V4H8" />
        ...
        {pulsing && (
          <span style={{ position: "absolute", top: -3, right: -3, width: 12, height: 12, borderRadius: "50%", backgroundColor: colors.semantic.warning, opacity: pulse }} />
        )}
      </div>
