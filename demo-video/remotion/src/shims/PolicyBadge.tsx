...
export const PolicyBadge: React.FC<{ checked?: boolean; style?: CSSProperties }> = ({
  ...
  >
    <svg width={30} height={30} viewBox="0 0 24 24" fill="none" stroke={colors.brand.primary} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
    ...
    {checked && (
      <svg width={24} height={24} viewBox="0 0 24 24" fill="none" stroke={colors.brand.primary} strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round" style={{ marginLeft: 10 }}>
