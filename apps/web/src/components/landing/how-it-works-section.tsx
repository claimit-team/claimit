            ...
            <Card className="mt-6 border-neutral-200 bg-neutral-0 p-6 lg:p-8">
              <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
                ...
                <div className="space-y-4">
                  <Card className="border-neutral-200 bg-neutral-50 p-0">
                    ...
                    <div className="p-4">
                      <p className="text-sm text-neutral-700">
                        I detected a price drop of $42.00 at BestBuy. The item is within the 30-day
                        price protection window. I&apos;ve prepared an email draft based on their
                        online form format.
                      </p>
                    </div>
                  </Card>
                  ...
                  <Card className="border-neutral-200 bg-neutral-50 p-0">
                    <div className="border-b border-neutral-200 px-4 py-3">
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <Badge
                          variant="outline"
                          className="border-neutral-200 bg-neutral-0 text-neutral-700 shrink-0"
                        >
                          Pending Review
                        </Badge>
                      </div>
