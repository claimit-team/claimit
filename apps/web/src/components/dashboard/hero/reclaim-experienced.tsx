        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
          <div>
            <div className="flex items-baseline gap-2 flex-wrap">
              <span className="text-4xl font-bold text-brand-accent-500">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
            ...
            <div className="text-center lg:text-right">
              <div className="text-xl font-semibold text-neutral-900">${averageReportedRefund}</div>
              <div className="text-sm text-neutral-600">Average reported refund</div>
            </div>
            <div className="text-center lg:text-right">
              <div className="text-xl font-semibold text-neutral-900">{claimsInProgress}</div>
